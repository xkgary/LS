...
namespace AutoLevelup
{
    class Program
    {
        ...
        public static void livellini()
        {
            ...
            else if (Player.BaseSkinName == "Amumu") abilitySequence = new int[] { 3, 1, 2, 3, 3, 4, 3, 1, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
    ...
    .Any(mastery => mastery.Id == 100 && mastery.Points == 1))
            ...
            else if (Player.BaseSkinName == "Jayce") { abilitySequence = new int[] { 1, 2, 3, 1, 1, 4, 1, 2, 1, 2, 4, 2, 3, 2, 3, 4, 3, 3 }; rOff = -1; }
    ...
    .Any(mastery => mastery.Id == 100 && mastery.Points == 1))
            ...
            else if (Player.BaseSkinName == "Rengar") abilitySequence = new int[] { 1, 2, 3, 1, 1, 4, 1, 2, 1, 2, 4, 2, 2, 3, 3, 4, 3, 3 };
            ...
            else if (Player.BaseSkinName == "Thresh") abilitySequence = new int[] { 1, 3, 2, 1, 1, 4, 1, 1, 3, 3, 4, 3, 3, 2, 2, 4, 2, 2 };
            ...
            else if (Player.BaseSkinName == "TwistedFate") abilitySequence = new int[] { 2, 1, 1, 3, 1, 4, 1, 2, 1, 2, 4, 2, 2, 3, 3, 4, 3, 3 };
    ...
    .Any(mastery => mastery.Id == 100 && mastery.Points == 1))
            ...
            else if (Player.BaseSkinName == "Warwick") abilitySequence = new int[] { 2, 1, 3, 1, 3, 4, 3, 1, 1, 2, 4, 1, 2, 2, 2, 4, 3, 3 };
            else if (Player.BaseSkinName == "MonkeyKing") abilitySequence = new int[] { 3, 2, 1, 3, 3, 4, 3, 1, 3, 1, 4, 1, 1, 2, 2, 4, 2, 2 };
